...
The [Founding Charter](https://github.com/bobflagg/WatchlineNYC/blob/main/documents/charter.md){:target="_blank"} describes the full design. A [live example](https://bobflagg.github.io/WatchlineNYC/){:target="_blank"} shows Watchline's response to: *Is 122 West 97th Street in Manhattan getting worse?*

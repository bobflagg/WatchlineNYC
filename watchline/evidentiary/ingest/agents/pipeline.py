...
Usage:
    uv run python -m watchline.evidentiary.ingest.agents.pipeline            # run all steps
    uv run python -m watchline.evidentiary.ingest.agents.pipeline --step load
    uv run python -m watchline.evidentiary.ingest.agents.pipeline --step store

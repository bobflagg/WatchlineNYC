...
Usage:
    uv run python -m watchline.evidentiary.ingest.acris.pipeline            # run all steps
    uv run python -m watchline.evidentiary.ingest.acris.pipeline --step load
    uv run python -m watchline.evidentiary.ingest.acris.pipeline --step store

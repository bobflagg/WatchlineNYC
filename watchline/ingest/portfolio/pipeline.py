...
Usage:
    uv run python -m watchline.ingest.portfolio.pipeline            # run all steps
    uv run python -m watchline.ingest.portfolio.pipeline --step init
    uv run python -m watchline.ingest.portfolio.pipeline --step load
    uv run python -m watchline.ingest.portfolio.pipeline --step project
    uv run python -m watchline.ingest.portfolio.pipeline --step wcc
    uv run python -m watchline.ingest.portfolio.pipeline --step store
    uv run python -m watchline.ingest.portfolio.pipeline --step reconcile
    uv run python -m watchline.ingest.portfolio.pipeline --step cleanup
